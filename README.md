...
2. Install [NetLogo](https://ccl.northwestern.edu/netlogo/) to the `bin/` folder;
3. Run the script `scripts/netlogo.sh` to open the `Formation Control Testbed.nlogo` project in the NetLogo IDE.
...
* [View of the region of the ATC mall where the dataset was recorded](https://maps.app.goo.gl/CNDDALfkda9CSmhZ6)
